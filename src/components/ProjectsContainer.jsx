...
const projects = [
    {id: "countries.gif", name: "Consulta e visualização de países utilizando API", app: "https://rest-countries-api-with-color-theme-switcher-master-sigma-six.vercel.app/", repositorie: "https://github.com/BraynnerM/rest-countries-api-with-color-theme-switcher-master", description: "Projeto feito utilizando React, typescript e sass neste projeto é utilizado o metodo fetch para busca em uma api local onde temos todos os países e vários dados sobre cada um, podemos filtrar os países por continente ou simplesmente pesquisar um país digitando no campo de pesquisa, além disso existe uma página de detalhes para cada país e foi implementado também utilizando context api um theme switcher."},
    ...
    {id: "accordion.gif", name: "Componente de FAQ - Acordeão", app: "https://braynnerm.github.io/faq-accordion-card-main/", repositorie: "https://github.com/BraynnerM/faq-accordion-card-main", description: "Pequeno projeto para fins educacionais, utilizando conceitos basicos de HTML, CSS, JavaScript e responsividade."},
